...
from main.model import get_resnet_model, get_tinyvit_model
...
def parse_args():
    ...
    parser.add_argument('--input', type=str, default='image22259.jpg', dest='input')
